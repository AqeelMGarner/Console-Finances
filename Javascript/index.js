...
console.log("Average Difference in Change: $" + averageDifference);
...
console.log("Greatest Increase in Profits: $" + max + " in " + maxMonth);

let min = 0;
let minMonth = "";
for (let month = 0; month < finances.length; month++) {
  let currentMonthValue = finances[month][1];
  if (currentMonthValue < min) {
    min = currentMonthValue;
    minMonth = finances[month][0];
  }
}
console.log("Greatest Decrease in Profits: $" + min + " in " + minMonth);
